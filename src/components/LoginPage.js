...
export default class LoginPage extends React.Component{
    ...
    render(){
        return(
            <div id="loginPage" style={{display: this.props.display ? "inline-block" : "none"}}>
                ...
                <p className="login-signup-text">Not interested in a membership? That's okay with us!<br/>The Chance app is <b>FREE</b> to use as a charitable organization directory.<br/>
                    <br/>
                    If you wish to continue as a guest, <span className="signup-link"  onClick={this.props.loginPage}>click here</span>.
                </p>
